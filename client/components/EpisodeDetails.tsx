      ...
      >
        <div
          style={{
            ...
            maxHeight: `calc(var(--scale) * ${(entry.runtime || entry.average_run_time) - 2}px + var(--height-mult) * ${(schedule[i + 1] ? (schedule[i + 1].runtime || schedule[i + 1].average_run_time) : 40) - 2}px)`,
          }}
        >
